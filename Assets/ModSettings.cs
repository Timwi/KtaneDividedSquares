...
class ModConfig<T>
{
    ...
    {
        SettingsPath = Application.isEditor ? @"Assets\DividedSquaresSettings.json" : Path.Combine(Path.Combine(Application.persistentDataPath, "Modsettings"), filename + ".json");
    }
