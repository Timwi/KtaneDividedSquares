...
public class DividedSquaresModule : MonoBehaviour
{
    ...
    private static readonly string[] _excludedModules = @"Divided Squares,Forget Me Not,Forget Everything,Hogwarts,Turn The Key,The Time Keeper,Souvenir,The Swan,Simon's Stages".Split(',');
